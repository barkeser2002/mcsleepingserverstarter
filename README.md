...
**Works better with [EmptyServerStopper](https://github.com/vincss/mcEmptyServerStopper) (1.13-1.19+) or [NoPlayerShutdown](https://www.curseforge.com/minecraft/mc-mods/no-player-shutdown) (1.20.1-1.21.1+), a plugin that automatically stops your server after a definied amount of time**
...
## 📜 ChangeLog
- 1.11.6 - MC 1.21.11 / Bedrock 1.21.40 :
